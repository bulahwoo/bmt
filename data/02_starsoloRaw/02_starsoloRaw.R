...
library(gt)
library(tximport)
setwd("/media/nguyen/Data1/github/bulahwoo/bmt/data/02_starsoloRaw/")
...
# load dge
dge <- ReadSTARsolo("/media/nguyen/Data1/mao/scseq/bombyx_mori_testes/starsolo/bmori_testes/Solo.out/Gene/raw/")
