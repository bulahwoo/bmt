...
library(gt)
library(tximport)
setwd("/media/nguyen/Data1/github/bulahwoo/bmt/data/04_dropseqT10/")
...
# load dge
dge <- read.table("/media/nguyen/Data1/mao/scseq/bombyx_mori_testes/dropseq/project__bmori_testes_01/output__bmori_testes_01/dge_t10.txt.gz", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
